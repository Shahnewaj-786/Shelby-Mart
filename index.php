<?php
 ...
 $utype_arr=array("Admin","Employee","Seller", "Buyer");
...
if(!$hasError){
    ...
    header("Location: View/employee/login.php");
        ...
        header("Location: View/seller/login.php");
    }

    else if($_POST["utype"]=="Buyer"){
...
<html>
    ...
    <body>
        <form action="" onsubmit="return validate()" method="post">
            ...
            <fieldset>
                <legend align="center"><h1>Welcome to Shelby Mart</h1></legend>
                    <table align="center">
                        <tr>
                            <td>
                                <img width="500" height="300" src="images/logo-shelby.png">
